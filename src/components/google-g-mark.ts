/**
 * Marca "G" oficial do Sign in with Google (cores da marca Google, não da paleta Encontra-me).
...
export const GOOGLE_G_IMAGE = {
  uri: `data:image/svg+xml;charset=utf-8,${encodeURIComponent(GOOGLE_G_SVG)}`,
} as const;
